...
def test_create_distance_matrix():
    ...
    new_dataframe = create_distance_dataframe(modle_tcd10_dataframe)
...
def generate_plots_for_validation_analyzis():
    ...
    modle_tcd10_distance_dataframe = create_distance_dataframe(modle_tcd10_dataframe)
    plotter.coorelate_matrix(modle_tcd10_distance_dataframe)
    mcool_5000_distance_dataframe = create_distance_dataframe(mcool_5000_dataframe)
